...
import projectHealthAsset from "@/assets/health-assistant.png.asset.json";

const PROJECT_IMAGES = [projectPayrollAsset.url, projectDeepfake, projectHealthAsset.url];
